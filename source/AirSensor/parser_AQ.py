...
class HONEYWELL_Parser(Parser):
    ...
    def parse(self):
        try:
            ...
            pm10_1 = int.from_bytes(sentence[5], byteorder='big')
            pm10_2 = int.from_bytes(sentence[4], byteorder='big')<<8

            pm2p5_1 = int.from_bytes(sentence[7], byteorder='big')
            pm2p5_2 = int.from_bytes(sentence[6], byteorder='big')<<8
