from zOLD.TaskInterface.QueueDefinition import TaskQueue
from zOLD.TaskInterface.WiFi_Task_Commands import Wlan0on, DnsmasqOn, SetIP, HostapdOn, Wlan0off, DnsmasqOff, HostapdOff
